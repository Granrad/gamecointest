...
const Ban = props => (
	<Panel id={props.id} separator={false}>
           <Placeholder
            ...
            action={<Button size="xl" mode="tertiary" href="https://vk.com/sanyok12345" target="_blank" >Купить разбан</Button>}
            stretched
          >
           {props.reason} <br />  <br /> Приобрести разблокировку можно <br /> за 129 рублей.
          </Placeholder>
	</Panel>
